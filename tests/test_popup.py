...
class PopupPlacementTests(unittest.TestCase):
    ...
    def test_supports_monitors_with_negative_coordinates(self) -> None:
        ...
        self.assertEqual(result, (-396, 576))

    def test_places_popup_two_centimeters_from_scaled_click(self) -> None:
        ...
        self.assertEqual(position, (1473, 673))
        self.assertAlmostEqual((position[0] - x) * 698 / 2560, 20, delta=0.2)
        self.assertAlmostEqual((position[1] - y) * 393 / 1440, 20, delta=0.2)

    def test_missing_monitor_dimensions_use_fallback(self) -> None:
        self.assertEqual(physical_popup_offsets(MONITOR, 0, -1), (76, 76))
